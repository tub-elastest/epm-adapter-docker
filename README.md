...
This repository contains an adapter to be used by the ElasTest Platform Manager to support docker as a virtualization technology. Further documentation can be found [here](https://github.com/mpauls/epm-adapter-docker/blob/master/docs/index.md).
