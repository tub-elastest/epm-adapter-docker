...
public final class AdapterHandlerGrpc {
   ...
   */
  public static AdapterHandlerBlockingStub newBlockingStub(
   ...
   */
  public static AdapterHandlerFutureStub newFutureStub(
      io.grpc.Channel channel) {
  ...
  /**
   */
  public static abstract class AdapterHandlerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void deleteAdapter(ResourceIdentifier request,
  ...
  /**
   */
  public static final class AdapterHandlerStub extends io.grpc.stub.AbstractStub<AdapterHandlerStub> {
    ...
    @Override
    protected AdapterHandlerStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class AdapterHandlerBlockingStub extends io.grpc.stub.AbstractStub<AdapterHandlerBlockingStub> {
    ...
    @Override
    protected AdapterHandlerBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    public Empty deleteAdapter(ResourceIdentifier request) {
      return blockingUnaryCall(
          getChannel(), METHOD_DELETE_ADAPTER, getCallOptions(), request);
    }
  }

  /**
   */
  public static final class AdapterHandlerFutureStub extends io.grpc.stub.AbstractStub<AdapterHandlerFutureStub> {
    ...
    @Override
    protected AdapterHandlerFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  private static final class AdapterHandlerDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @Override
